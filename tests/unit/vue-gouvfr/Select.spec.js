...
describe('Select.vue', () => {
    describe('Basic use', () => {
        beforeEach(() => (wrapper = shallowMount(Select, { propsData: propsDataBasic })))
    ...
    describe('Modifier classes', () => {
        it("is disabled when isDisabled is true", () => {
            wrapper = shallowMount(Select, { propsData: propsDataDisabled })
            expect(wrapper.find('.rf-select').element.disabled).toBe(true)
        })
        it("has the error class when isError is true", () => {
            wrapper = shallowMount(Select, { propsData: propsDataError })
        ...
        it("has the valid class when isValid is true", () => {
            wrapper = shallowMount(Select, { propsData: propsDataValid })
    ...
    describe('Use with option groups', () => {
        beforeEach(() => (wrapper = shallowMount(Select, { propsData: propsDataGrouped })))
